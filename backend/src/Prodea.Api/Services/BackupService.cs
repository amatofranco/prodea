                ...
                var message = new EmailMessage
                {
                    ...
                    HtmlBody = $"""
                        <div style="font-family:monospace;background:#0D0D0D;color:#fff;padding:24px;border-radius:8px;max-width:600px;">
                          ...
                          <p style="color:#8A8A9A;margin:0 0 16px;">Predictions: <strong style="color:#fff">{predictions.Count}</strong> &nbsp;|&nbsp; Size: <strong style="color:#fff">{sizeKb:F1} KB</strong></p>
                        ...
                        """,
                    TextBody    = $"Prodea backup {payload.GeneratedAt:yyyy-MM-dd HH:mm} UTC — {predictions.Count} predictions ({sizeKb:F1} KB). See attached file.",
