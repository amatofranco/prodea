            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#8A8A9A] text-xs">Jornada {b.matchday}</span>
                </div>
                <p className="text-white/60 text-xs italic mt-1 truncate">"{b.randomPhrase}"</p>
              </div>
              ...
              <button
                onClick={() => setSelectedBadge(selectedBadge?.matchday === b.matchday ? null : b)}
